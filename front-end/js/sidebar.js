...
darkModeButton.addEventListener("click", function(){
  ...
  if(button.checked){
    ...
    r.style.setProperty('--sidebar-icon-color', 'invert(88%) sepia(21%) saturate(3721%) hue-rotate(339deg) brightness(93%) contrast(86%)');
    r.style.setProperty('--sidebar-icon-color-hover', 'invert(11%) sepia(25%) saturate(573%) hue-rotate(176deg) brightness(98%) contrast(89%)');
    ...
    r.style.setProperty('--sidebar-icon-color', 'invert(93%) sepia(12%) saturate(197%) hue-rotate(106deg) brightness(92%) contrast(88%)');
    r.style.setProperty('--sidebar-icon-color-hover', 'invert(20%) sepia(19%) saturate(944%) hue-rotate(166deg) brightness(95%) contrast(86%)');
    r.style.setProperty('--search-bar-background-color', 'rgb(207, 216, 226)');
